...
// ✅ Hardcoded RPC (NO MORE relying on wallet RPC)
const RPC_ENDPOINT = "https://mainnet.helius-rpc.com/?api-key=dd83bdd4-73b2-48af-be72-96cbbe97c9a4";
    ...
    <section className="container mx-auto px-4 py-20">
      <Card className="max-w-2xl mx-auto p-10 bg-card/90 backdrop-blur-sm border-border shadow-intense hover:shadow-intense">
        <div className="text-center space-y-10">
          ...
          <Button variant="web3" size="lg" className="w-full h-14 text-lg font-semibold" onClick={handleBuy} disabled={loading}>
